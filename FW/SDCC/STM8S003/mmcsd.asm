...
;	../src/mmcsd.c: 1035: SPI->CR1 = SPI_FIRSTBIT_MSB | SPI_BAUDRATEPRESCALER_64|SPI_CLOCKPOLARITY_HIGH | SPI_CLOCKPHASE_2EDGE;
	mov	0x5200+0, #0x2b
;	../src/mmcsd.c: 1037: SPI->CR2 = SPI_DATADIRECTION_2LINES_FULLDUPLEX|SPI_NSS_SOFT;
	mov	0x5201+0, #0x02
;	../src/mmcsd.c: 1038: SPI->CR2 |= SPI_CR2_SSI;
	bset	20993, #0
;	../src/mmcsd.c: 1040: SPI->CR1 |= SPI_MODE_MASTER;
	bset	20992, #2
;	../src/mmcsd.c: 1042: SPI->CRCPR = 0x07;
	mov	0x5205+0, #0x07
;	../src/mmcsd.c: 1045: SPI->CR1 |= SPI_CR1_SPE;
	bset	20992, #6
;	../src/mmcsd.c: 1049: SD_CS_GPIO_PORT->CR2 &= (~SD_CS_PIN); //Reset corresponding bit
	bres	20494, #4
;	../src/mmcsd.c: 1050: SD_CS_GPIO_PORT->ODR |= SD_CS_PIN; // high level
	bset	20490, #4
;	../src/mmcsd.c: 1051: SD_CS_GPIO_PORT->DDR |= SD_CS_PIN; // output mode 
	bset	20492, #4
;	../src/mmcsd.c: 1052: SD_CS_GPIO_PORT->CR1 &= ~SD_CS_PIN; //open drain here
	bres	20493, #4
;	../src/mmcsd.c: 1053: }
	ret
	.area CODE
